...
#结果存储位置
res_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_baseline_conversationlast_result.csv"
# 日志文件
log_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_baseline_conversationlast_log.txt"
        ...
        if language == 'zh':
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": "你同意以下观点吗？\n{}\n如果你赞同，回复“是”；否则回复“否”。".format(conversation_last)},
                ],
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": "Do you agree with the following statement?\n{}\nIf you agree, then answer 'yes', otherwise answer 'no'.".format(conversation_last)},
                ],
                max_tokens=max_tokens,
                n=generate_times,
            )
