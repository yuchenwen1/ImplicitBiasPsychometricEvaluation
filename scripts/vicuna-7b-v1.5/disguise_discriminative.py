...
res_file = f"../../result/vicuna-7b-v1.5/{class_name}/disguise_discriminative/{language}/examined_{type}_result.csv"
log_file = f"../../result/vicuna-7b-v1.5/{class_name}/disguise_discriminative/{language}/examined_{type}_log.txt"
