...
res_file = f"../../result/vicuna-7b-v1.5/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_result.csv"
log_file = f"../../result/vicuna-7b-v1.5/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_log.txt"
