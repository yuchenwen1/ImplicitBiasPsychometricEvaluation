...
res_file = f"../../result/vicuna-7b-v1.5/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_result.csv"
log_file = f"../../result/vicuna-7b-v1.5/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_log.txt"
