...
res_file = f"../../result/Qwen2-7B-Instruct/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_result.csv"
log_file = f"../../result/Qwen2-7B-Instruct/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_log.txt"
