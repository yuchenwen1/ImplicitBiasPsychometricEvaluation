...
res_file = f"../../result/Qwen2-7B-Instruct/{class_name}/baselines_discriminative/{language}/examined_system_context_{type}_result.csv"
log_file = f"../../result/Qwen2-7B-Instruct/{class_name}/baselines_discriminative/{language}/examined_system_context_{type}_log.txt"
total_agree_log_file = f"../../result/Qwen2-7B-Instruct/total_agree_log.txt"
total_disagree_log_file = f"../../result/Qwen2-7B-Instruct/total_disagree_log.txt"
total_refuse_log_file = f"../../result/Qwen2-7B-Instruct/total_refuse_log.txt"
total_error_log_file = f"../../result/Qwen2-7B-Instruct/total_error_log.txt"
