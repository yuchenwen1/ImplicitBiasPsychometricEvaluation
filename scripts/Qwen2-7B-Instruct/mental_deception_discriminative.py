...
res_file = f"../../result/Qwen2-7B-Instruct/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_result.csv"
log_file = f"../../result/Qwen2-7B-Instruct/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_log.txt"
