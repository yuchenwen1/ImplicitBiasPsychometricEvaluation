...
res_file = f"../../result/Qwen2-7B-Instruct/{class_name}/disguise_discriminative/{language}/examined_{type}_result.csv"
log_file = f"../../result/Qwen2-7B-Instruct/{class_name}/disguise_discriminative/{language}/examined_{type}_log.txt"
