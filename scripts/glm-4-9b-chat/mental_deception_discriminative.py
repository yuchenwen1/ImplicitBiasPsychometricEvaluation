...
res_file = f"../../result/glm-4-9b-chat/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_result.csv"
log_file = f"../../result/glm-4-9b-chat/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_log.txt"
