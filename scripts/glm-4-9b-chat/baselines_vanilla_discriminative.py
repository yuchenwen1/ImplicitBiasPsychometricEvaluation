...
res_file = f"../../result/glm-4-9b-chat/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_result.csv"
log_file = f"../../result/glm-4-9b-chat/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_log.txt"
