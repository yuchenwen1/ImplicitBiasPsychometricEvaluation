...
res_file = f"../../result/glm-4-9b-chat/{class_name}/disguise_discriminative/{language}/examined_{type}_result.csv"
log_file = f"../../result/glm-4-9b-chat/{class_name}/disguise_discriminative/{language}/examined_{type}_log.txt"
