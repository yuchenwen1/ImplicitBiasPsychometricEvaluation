...
res_file = f"../../result/glm-4-9b-chat/{class_name}/baselines_discriminative/{language}/examined_system_context_{type}_result.csv"
log_file = f"../../result/glm-4-9b-chat/{class_name}/baselines_discriminative/{language}/examined_system_context_{type}_log.txt"
total_agree_log_file = f"../../result/glm-4-9b-chat/total_agree_log.txt"
total_disagree_log_file = f"../../result/glm-4-9b-chat/total_disagree_log.txt"
total_refuse_log_file = f"../../result/glm-4-9b-chat/total_refuse_log.txt"
total_error_log_file = f"../../result/glm-4-9b-chat/total_error_log.txt"
