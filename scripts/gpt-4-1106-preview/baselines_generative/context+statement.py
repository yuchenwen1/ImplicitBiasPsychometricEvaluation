...
#结果存储位置
res_file = f"../../../result/{model}/{class_name}/baselines_generative/{language}/examined_context_statement_{type}_writing.csv"
        ...
        if language == 'zh':  
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    ...
                    {"role": "user", "content": "{}\n在这种情况下，请对以下句子进行续写：\n{}".format(row['context'],row['statement'])},
                ],
            ...
            response = openai.ChatCompletion.create(
                ...
                {"role": "user", "content": "{}\nUnder this circumstance, please continue writing the following sentence:\n{}".format(row['context'],row['statement'])},
                ],
                max_tokens=max_tokens,
                n=generate_times,
            )
