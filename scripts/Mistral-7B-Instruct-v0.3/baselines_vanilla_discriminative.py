...
res_file = f"../../result/Mistral-7B-Instruct-v0.3/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_result.csv"
log_file = f"../../result/Mistral-7B-Instruct-v0.3/{class_name}/baselines_discriminative/{language}/examined_vanilla_{type}_log.txt"
...
with open(total_agree_log_file, 'a+') as f:
    f.write(f"{language}|{class_name}|baselines_discriminative|vanilla|{str(total_yes_rate)}\n")
    
with open(total_disagree_log_file, 'a+') as f:
    f.write(f"{language}|{class_name}|baselines_discriminative|vanilla|{str(total_no_rate)}\n")

with open(total_refuse_log_file, 'a+') as f:
    f.write(f"{language}|{class_name}|baselines_discriminative|vanilla|{str(total_refuse_rate)}\n")
    
with open(total_error_log_file, 'a+') as f:
    f.write(f"{language}|{class_name}|baselines_discriminative|vanilla|{str(total_error_rate)}\n")