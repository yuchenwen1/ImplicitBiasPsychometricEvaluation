...
res_file = f"../../result/Mistral-7B-Instruct-v0.3/{class_name}/disguise_discriminative/{language}/examined_{type}_result.csv"
log_file = f"../../result/Mistral-7B-Instruct-v0.3/{class_name}/disguise_discriminative/{language}/examined_{type}_log.txt"
