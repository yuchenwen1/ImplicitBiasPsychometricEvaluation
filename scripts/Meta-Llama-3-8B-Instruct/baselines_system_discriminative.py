...
res_file = f"../../result/Meta-Llama-3-8B-Instruct/{class_name}/baselines_discriminative/{language}/examined_system_{type}_result.csv"
log_file = f"../../result/Meta-Llama-3-8B-Instruct/{class_name}/baselines_discriminative/{language}/examined_system_{type}_log.txt"
