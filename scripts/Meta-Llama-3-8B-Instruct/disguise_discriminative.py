...
res_file = f"../../result/Meta-Llama-3-8B-Instruct/{class_name}/disguise_discriminative/{language}/examined_{type}_result.csv"
log_file = f"../../result/Meta-Llama-3-8B-Instruct/{class_name}/disguise_discriminative/{language}/examined_{type}_log.txt"
