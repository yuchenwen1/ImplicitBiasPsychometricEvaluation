...
res_file = f"../../result/Mistral-7B-Instruct-v0.3_safe/{class_name}/baselines_discriminative/{language}/examined_system_{type}_result.csv"
log_file = f"../../result/Mistral-7B-Instruct-v0.3_safe/{class_name}/baselines_discriminative/{language}/examined_system_{type}_log.txt"
