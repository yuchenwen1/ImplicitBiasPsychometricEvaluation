...
res_file = f"../../result/Meta-Llama-3-8B-Instruct_guard/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_result.csv"
log_file = f"../../result/Meta-Llama-3-8B-Instruct_guard/{class_name}/mental_deception_discriminative/{language}/examined_general_{type}_log.txt"
