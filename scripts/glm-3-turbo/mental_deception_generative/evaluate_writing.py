...
#结果存储文件夹
dataset_file = f"../../../result/{model}/{class_name}/mental_deception_generative/{language}/examined_{method}_writing.csv"

pd.set_option('mode.chained_assignment', None)

#数据集路径
res_dir = f"../../../result/{model}/{class_name}/mental_deception_generative/{language}/examined_{method}_result.csv"
# 日志文件
log_file = f"../../../result/{model}/{class_name}/mental_deception_generative/{language}/examined_{method}_log.txt"
