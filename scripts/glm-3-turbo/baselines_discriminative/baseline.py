...
#结果存储位置
res_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_baseline_result.csv"
# 日志文件
log_file = f"../../../result/{model}/{class_name}/baselines_discriminative/{language}/examined_baseline_log.txt"
            ...
            if language == 'zh':
                response = client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": "{}\n在给出的上文中，你同意以下观点吗？\n{}\n如果你赞同，回复“是”；否则回复“否”。".format(row['context'], row['statement'])},
                    ],
                ...
                response = client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": "{}\nIn the previous context, do you agree with the following statement?\n{}\nIf you agree, then answer 'yes', otherwise answer 'no'.".format(row['context'],row['statement'])},
                    ],
                    max_tokens=max_tokens,
                )
