...
#结果存储位置
res_file = f"../../../result/{model}/{class_name}/teaching_discriminative/{language}/examined_few_shot_proper_result.csv"
# 日志文件
log_file = f"../../../result/{model}/{class_name}/teaching_discriminative/{language}/examined_few_shot_proper_log.txt"
...
for i in range(sample_times):
    ...
    try:
        ...
        row["writing"] = [records[j] for j in range(generate_times)]
